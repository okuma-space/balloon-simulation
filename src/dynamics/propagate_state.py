...
#     out_temperature = layered_temperature_model.calculate_temperature(
#         altitude
#     )  # 外気温[K]
...
#     # 大気圧
#     out_pressure = isothermal_model.calculate_pressure(
#         isothermal_model.calculate_density(altitude),
#         altitude,
#     )
...
#             # ガス質量を更新
#             gas_mass = gas_mass - vent_flow_mass_rate * time_step_seconds
#             break
...
def propagate_state(
    ...
    # 排気スケジュール確認
    if vent_schedule.is_open(current_time):
        inner_pressure = balloon_mechanics.calculate_balloon_pressure(
            gas_temperature,
            gas_mass,
            volume,
